...
def state_to_features(game_state: dict) -> np.array:
    ...
    dist = distance(nearest_coin)
    if nearest_coin[0] == position[0] and nearest_coin[1] != position[1] and wallsAroundCoinFeature == 1:
        dist += 2
    elif nearest_coin[0] != position[0] and nearest_coin[1] == position[1] and wallsAroundCoinFeature == -1:
        dist += 2

    return feature_value, dist
